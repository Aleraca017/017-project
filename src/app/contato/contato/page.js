...
export default function ContatoPage() {
  ...
  return (
    <Layout>
      <section className="min-h-screen flex items-center justify-center px-6 py-16 bg-gradient-to-b from-black to-zinc-900 text-white">
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center items-center md:w-[90%] w-full md:items-start text-center md:text-left">
            ...
            <div className="w-full bg-zinc-800/60 rounded-xl p-4 text-left text-sm text-gray-300 shadow-md">
          ...
          <div className="w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <textarea
                ...
                required
                rows={5}
                className="w-full min-h-13 max-h-64 bg-zinc-800 border border-zinc-700 rounded-lg px-4 py-3 text-white placeholder-gray-400"
              />

              <button
                type="submit"
                className="bg-purple-600 hover:bg-purple-700 transition rounded-lg px-6 py-3 font-semibold"
              >
                Enviar Mensagem
              </button>
            </form>
